...
>
> **Last updated:** 2026-05-31. All 51 jurisdictions are now ✅ live — Wyoming
> (WY) was the last, shipped 2026-05-31. Per the purpose note above, this
> tracker can be deleted now that every row is ✅. The intent was to ship one
> state at a time so any session — including one with no prior conversation
> context — could read this doc and pick up the next state.
>
...
| 45 | UT | Utah | 215 | ✅ | shipped 2026-05-30. Pearson VUE-administered for the Utah Division of Real Estate (Department of Commerce); entry license = Sales Agent. Verified facts against the Pearson VUE Utah Real Estate Candidate Handbook #094500 (July 2024, rev01/2026) + National/Utah State Content Outlines #094502 (national salesperson outline eff. 04/01/2025, Utah state outline eff. 07/15/2016): combination Sales Agent exam 130 scored (80 national + 50 Utah state), single 4-hour session (the handbook gives one 4h block, no per-portion minute split), scaled 70 per portion scored separately, $69 Pearson VUE fee (handbook p.1 says "($69)"; prep sites citing $59/$52 are stale). Passing is an equated scaled score (0–100), explicitly NOT a raw percentage per the handbook, so the page says "70 (scaled)" not "70%". Audit found NO wrong answers across the picked 20: verified the in-state trust-account requirement (R162-2f-403a genuinely requires a bank/credit union located in Utah — NOT an Iowa-style error), broker may keep up to $1,000 personal funds in trust for bank charges (R162-2f-403a, so Q20's $50 scenario is permitted and the "$500 max" distractor is wrong), Recovery Fund $15,000/transaction + $50,000/licensee caps (Utah Code 61-2f Part 5, §61-2f-507), attorney licensing exemption (61-2f-202), seller/buyer/limited agency only (no transaction/designated), REPC approved by the Real Estate Commission + Attorney General, trust-deed / non-judicial-foreclosure state. Q8 explanation slightly overstates the Seller's Property Condition Disclosure as a statutory form mandate (Utah's hard statutory disclosure is narrower; the common-law material-defect duty + the customary UAR form back it) but the marked answer is the correct pick. Filter expanded with 3 UT-only phrases (total-exam-time trivia, passing-score trivia, 1-year education-completion deadline) to drain UT-02 exam-format/process leaks; promoted the substantive attorney-exemption question into the displayed 20. Diffed all 45 built state pages before/after the filter change — only Utah changed. No question JSON edited, so no mobile-repo commit and no Supabase re-seed. |
| 46 | VT | Vermont | 220 | ✅ | shipped 2026-05-30. Verified against VT OPR Real Estate Commission State Jurisprudence Exam PDF (Sales Exam #1, May 2026) + sos.vermont.gov real-estate page + PSI candidate info: 100-question national portion (2.5h, scaled 75%, $110 via PSI) plus a separate 50-question open-book state jurisprudence exam (passing 75, no fee, submitted via the OPR online application). Competitor "36-question PSI state portion" claim is stale — regulator governs. Facts cross-checked against 32 V.S.A. §9602 (transfer tax 0.5% on first $200k, eff. 8/1/2024), 9 V.S.A. §4503 (fair-housing age), 32 V.S.A. ch.236 (land gains <6yr + subdivided per Act 175), 26 V.S.A. §2251 (Commission composition). Audit: Q14 wrong — VT has NO statewide security-deposit cap (9 V.S.A. §4461; the 1-mo/2-mo "cap" was fabricated, only local ordinances like Burlington cap), flipped answer + fixed the second non-displayed §4461 cap question; Q1 explanation corrected from "5 licensees + 2 public" to 3 brokers + 1 salesperson + 1 attorney + 2 public (§2251). Re-seeded VT-01/VT-14 to Supabase | **Full question review 2026-07-26**: all 220 reviewed against 26 V.S.A. ch. 41, the Dec-2015 Commission rules, 3 V.S.A. 127/129a/130a, 9 V.S.A. ch. 137/139, 32 V.S.A. ch. 231/236 + 5847, 10 V.S.A. ch. 21/49A/151, 18 V.S.A. ch. 38, 27 V.S.A. 342, and Acts 181 (2024) / 152 (2026). **133 edited (21 C / 10 P / 102 M)** across questions, VT.md, articles_vt_rebuilt.sql and seed_standards_VT.sql; pushed to prod Supabase and **verified 220/220**, web JSONs synced byte-identical, Astro build + built page re-checked. Key C-flags: month-to-month no-cause notice is **60/90 days** not 30/60 (9 V.S.A. 4467(c)); Vermont **does** have an owner-occupied fair-housing exemption at **3 or fewer units** (9 V.S.A. 4504(2)); Vermont is a **pure NOTICE** recording state, not race-notice (Title Standard 2.5); **leasing/property management is NOT licensed** (26 V.S.A. 2211(b)(8)); dual agency is **prohibited outright**, consent does not cure it; a firm **may** put its own money in the trust account for bank fees (Rule 4.7(i)) and the fabricated 10-day trust-account notification rule was removed; **Form PTT-172** not PT-172; nonresident withholding is a flat **2.5% of price** with no 6.5%-of-gain alternative; land gains has **no general family exemption** and only reaches land the transferor subdivided (Act 175, 2020); appeals go to an **OPR appellate officer** then the Supreme Court, not to court first; Commission has **4 licensee seats** of 7, not 5; **Act 152 of 2026** extended the interim housing exemptions and pushed Tier 3 to 2028. Web page intro fixed — it had said Vermont allows dual agency with written consent. Write-up: realready/docs/VT_QUESTION_REVIEW_2026-07-26.md
| 47 | VA | Virginia | 250 | ✅ | shipped 2026-05-30. PSI-administered for the Virginia Real Estate Board (DPOR). Verified against PSI Candidate Information Bulletin (rev 12/7/2022) + DPOR: 120 Q (80 national/40 state), 150 min, 70% national / 75% state, $60. Audit fixed bank errors in web + outer + Supabase (re-seeded VA-05/09/11/12/15): condo developer cancellation 10→5 days (§ 55.1-1974); settlement not attorney-only, RESA settlement agents (§ 55.1-1000); Residential Property Disclosure Act is a single buyer-beware statement, not "two options" (§ 55.1-703); independent-contractor explanation tightened (§ 54.1-2138.1). |
| 48 | WA | Washington | 230 | ✅ | shipped 2026-05-30. Verified facts against the PSI Washington Real Estate Candidate Information Bulletin (© 2024, dated 3/28/2024, for the WA Real Estate Commission) + dol.wa.gov real-estate-brokers exam page. Broker is WA's ENTRY-LEVEL license (managing broker needs 3 yrs experience). Split exam: 100 national (150 min) + 30 state (90 min) = 130 scored, 240 min total, scaled score of 70 on EACH portion, $210 PSI fee covering both portions. State outline (handbook pp.13): general rules + Real Estate Commission/Director powers, licensing requirements, statutes/rules governing licensee activity (trust accounts, prohibited conduct, compensation, advertising, property mgmt, supervision), and brokerage relationships/agency (RCW 18.86). Audit: getStateData filter expanded with 7 WA-only patterns to drop licensing-process/CE leaks (WA-03 application-deadline + managing-broker-experience; WA-04 "3-hour WA Core" CE, Fair Housing CE hours, name/address-change) that were occupying displayed slots — each grep-verified to match only WA. WA-07.1 explanation corrected: original claimed trust-account monthly reconciliation "cannot be delegated to other licensees," which is false — WAC 308-124C-137 lets the designated broker delegate the work to a managing broker (cite tightened to WAC 308-124C-125/308-124E-105; answer "designated broker" unchanged). Fixed in all 3 layers: web (layer 2) + outer repo (layer 3) + Supabase reseed (layer 4). WA IS fully provisioned in Supabase (15 standards rows WA-01..15, 15 question rows each), so the mobile app serves WA and the reseed was required. `seed-questions.ts WA-07 --reseed` deleted 15 + reinserted 15 from the corrected file. (Schema gotcha: the Supabase `standards` lookup column is `ref`, not `standard_ref` — my first check queried the wrong column, errored, and I briefly mis-recorded WA as having zero rows.) |
| 49 | WV | West Virginia | 195 | ✅ | shipped 2026-05-31. Pearson VUE-administered for the West Virginia Real Estate Commission; entry license = Salesperson. Verified facts against the official WV 2026 Pearson VUE candidate handbook ("State Outlines (PDF)/West Virginia 2026.pdf", rev01/2026) Available-Exams table + Score-Explanation page + state content outline (eff. 1/1/2024): combination Salesperson exam 130 scored (80 national/150 min + 50 state/60 min = 210 min), 70% per portion scored separately, $59 per exam part. Corrected an earlier draft that had used a stale generic PSI handbook (fee $93→$59, provider PSI→Pearson VUE, passing 75%→70%, count 110→130). Q1/Q13 commission composition verified: 5 members appointed by the Governor (4 licensed brokers/assoc brokers/salespersons with 10+ yrs as primary vocation + 1 citizen member), WV Code §30-40-6. No question JSON edited — instead drained the wholly-process WV-04 (pre-license education + exam format/provider/passing-score) and WV-06 (renewal/CE/license-status/broker-transfer) state_licensing buckets via 18 new WV-scoped LICENSING_PROCESS_PATTERNS in getStateData.ts so all 20 displayed Q are substantive WV law (commission powers, trust accounts, UPL, advertising, agency/Notice-of-Agency, dual agency, fair housing incl. WV-specific blindness/ancestry classes + Mrs. Murphy 4-unit). Regression-tested: diffed all built state pages before/after the filter change — only west-virginia changed (no live state affected). Steps 6b/6c (mobile repo + Supabase) correctly skipped since no question JSONs changed. |
| 50 | WI | Wisconsin | 261 | ✅ | shipped 2026-05-31. Pearson VUE-administered for the Wisconsin Dept of Safety and Professional Services (DSPS); rules are the Real Estate Examining Board (REEB) chapters of the Wis. Admin. Code, statutes are Wis. Stat. Ch. 452. Verified facts against the Pearson VUE Wisconsin Real Estate Candidate Handbook (stock #0950-00, rev 12/20R) + embedded WI Salesperson Content Outline (eff. 7/1/2016) + WRA exam-info page + dsps.wi.gov: **SINGLE combined 140-question exam** (no split national/state portions — the 10 content areas sum to exactly 140 scored items + 5-10 unscored pretest), 4h, passing score is a **scaled 75 on a 0-100 scale** (handbook Score Explanation: "should not be interpreted as the percentage or number of questions answered correctly" — so the page shows "75 (scaled)" not "75%", same call as UT/VT), $65 Pearson VUE fee. Audit: **FIXED WI-01 + WI-12** — the "licensees must use REEB-approved forms where they exist" rule is **Wis. Admin. Code REEB 16.04** ("When to utilize approved forms"), NOT Wis. Stat. 452.135 (which is actually "Disclosure of duties"); corrected the displayed Q plus the rest of the WI-12.1 topic group + the WI-01.3 non-approved-forms reference, across web (layer 2) + outer repo (layer 3) + Supabase reseed (layer 4, WI-01/WI-12 = 15 rows each). Verified correct (no change): 452.14 discipline grounds (commingling/misrepresentation/undisclosed principal), 106.50 Open Housing classes (lawful source of income/age 18+/marital status/ancestry/sexual orientation beyond the federal FHA), REEB 18.031 48-hour trust deposit + holiday 2-business-day rule, Ch. 709 RECR 10-days-after-acceptance, 77.22 transfer fee $0.30 per $100 (2023 SB274 cut to $0.20 did not pass), 452.134 dual-agency written consent, four agency types incl. subagent, WB-1 Residential Listing Contract + WB-11 Residential Offer to Purchase, 2024 WB-form "There is no standard market commission rate" language (NAR-settlement revision, mandatory 8/15/2024), tenancy-in-common default, ATCP 134/DATCP rental rule. Drained the **wholly-process WI-02 state_licensing bucket** (pre-license hours, semester-credit completion window, minimum age, exam-format incl. a WRONG "75% on each portion" item that itself contradicts the single-exam/scaled-75 reality, criminal-record eligibility, CE hours, biennial renewal date/fee, broker experience) via 8 WI-scoped LICENSING_PROCESS_PATTERNS so all 20 displayed Q are substantive WI law; each pattern grep-verified to match only WI-02 in the question_text+answer haystack (WI-01/03/04 survivor counts unchanged 12/15/14) and a before/after build diff of all 51 state pages changed only wisconsin. Minor flag (NOT fixed, answer correct): WI-07 (×19) + WI-08 (×3) call the firm's supervising broker the "designated broker"; WI's statutory term is "supervising broker" (Wis. Stat. 452.12(5)). Answer is unambiguous vs its distractors and "designated broker" is a common cross-state synonym, so it is a terminology imprecision rather than a wrong answer — left as a documented flag for a possible later bank-wide rename. |
| 51 | WY | Wyoming | 190 | ✅ | shipped 2026-05-31. Pearson VUE-administered for the Wyoming Real Estate Commission (WREC). Verified facts against the Pearson VUE Wyoming Real Estate Candidate Handbook (#095100, July 2024, rev04/2025) + Wyoming state content outline (#095101, eff. 01/01/2021) + national salesperson outline (eff. 04/01/2025): two-portion Salesperson exam — National (80 scored + 5 pretest, 2.5h) + Wyoming (40 scored + 5–10 pretest, 1.5h) = 120 scored, 240 min; passing is a SCALED 75 on each portion (0–100 scale; handbook Score Explanation: "neither the number nor the percentage of questions answered correctly" — so the page shows "75 (scaled)" not "75%", same call as AK/UT/VT/WI); $80 per portion at a test center ($160 for both, $90/portion via OnVUE). Portions scored separately — pass one/fail the other retakes only the failed part within 6 months (unlike AK's whole-exam retake). Audit: NO wrong answers in the substantive displayed 20 — verified WREC composition (5 members, Governor + Senate consent, 3–4 active licensees w/ 5+ yrs, W.S. 33-28-105), dual agency PROHIBITED since 2008 with intermediary + designated agents as the alternative and customer as the default (W.S. 33-28-301/302), agent owes full fiduciary duties, agency disclosure before any substantive discussion, first-banking-day trust deposit + genuine in-state trust account (W.S. 33-28-122 / WAC ch.5 — NOT an Iowa-style error), broker-name-required advertising / blind-ad prohibition, E&O $100k per claim / $500k aggregate / $1k max deductible (W.S. 33-28-401), recovery account $20 fee + $10,000 per-claim cap + $20k/$50k education-fund allocation thresholds + suspend-until-repaid-at-18% (W.S. 33-28-201..203; the "$4,000" figure on older statute copies is stale, current cap is $10k), no statutory security-deposit cap + 30-day / 15-day-after-forwarding-address return (W.S. 1-21-1208), judicial + non-judicial foreclosure with 3-mo residential / 12-mo agricultural redemption + deficiency judgments (W.S. Title 1 Ch. 18), rectangular-survey land descriptions. No question JSON edited — instead drained 5 WY-scoped exam-format/process leaks via getStateData.ts LICENSING_PROCESS_PATTERNS (WY-02 "scores 68%" exam-scoring, "testing vendor", "exam is structured", Salesperson I/II pre-license sequence; WY-03 "forgot to complete CE" renewal) so all 20 displayed Q are substantive WY law; each pattern grep-verified to match only WY-02/WY-03 (zero non-WY/national matches) and a before/after build diff of all 51 state pages changed only wyoming. Steps 6b/6c (mobile repo + Supabase) correctly skipped — no question JSONs changed. FLAGGED (NOT fixed; drained from web display but still in the mobile bank): WY-02's three exam-format questions assert a WRONG "70% per portion" passing standard — Wyoming's actual standard is a scaled 75 that is explicitly not a percentage (same wrong-exam-format situation WI flagged). Recommend a future WY-02 bank fix + Supabase reseed to correct it for mobile-app users. |

**Progress: 51 / 51 live — every jurisdiction is ✅. Per the purpose note at the top, this tracker can now be deleted.**
