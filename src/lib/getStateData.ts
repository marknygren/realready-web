...
const LICENSING_PROCESS_PATTERNS = [
  ...
  /\bce (hours?|requirements?|curriculum|courses?|electives?|deadlines?|topic|topics)\b/i,
  /\bhours? of CE\b/i,
  ...
  /\bnon-?renewable\b/i,
  /\bbienni(al|ally)\b/i,
  /\bupgrade to associate broker\b/i,
  /\bapplies for (a |an )?(associate|designated) broker license\b/i,
  /\bmust be at least 18\b/i,
  /\bcourses? i{1,3}\b/i,
  /\breciprocity\b/i,
  /\bnon-?resident applicant\b/i,
  /\bcost to renew\b/i,
  /\blate renewal\b/i,
